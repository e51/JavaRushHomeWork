...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("task_04_", null);
    ...
    public static class ClassWithStatic {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            ClassWithStatic.staticString = file.readLine();
            this.i = Integer.valueOf(file.readLine());
            this.j = Integer.valueOf(file.readLine());
